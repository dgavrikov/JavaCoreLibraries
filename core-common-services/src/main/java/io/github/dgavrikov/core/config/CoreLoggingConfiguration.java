...
import io.github.dgavrikov.core.service.logging.MdcLoggingWrappingAppender;
import io.github.dgavrikov.core.service.logging.filter.LogbookJsonPathBodyFilter;
import io.github.dgavrikov.core.service.logging.filter.LogbookJsonPathHeaderFilter;
...
@ComponentScan(basePackages = "io.github.dgavrikov.core.masking.pattern")
public class CoreLoggingConfiguration {
    ...
    private ObjectWriter maskingObjectMapper(Jackson2ObjectMapperBuilder builder) {
        ...
        Class<?>[] classes = findAnnotationClassesWithReflections("io.github.dgavrikov.core.masking.annotation")
                .toArray(Class[]::new);
